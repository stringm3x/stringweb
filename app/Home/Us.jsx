  ...
  return (
    <div className="h-screen p-10 sm:p-20">
      <div className="relative h-full w-full p-3 sm:p-10">
        <Image src="/sonido.png" alt="us" fill className="object-cover absolute brightness-75 rounded-2xl" />
        ...
        <Button className="relative bg-green text-bg font-bold px-10">Acerca de STRING</Button>
      </div>
    </div>
  );
};
